...
#define BLACK_TRANS      CLITERAL(Color){ 0, 0, 0, 200 }         // Black
#define BLACK_TRANS_100      CLITERAL(Color){ 0, 0, 0, 100 }         // Black
#define BLANK      CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
#define MAGENTA    CLITERAL(Color){ 255, 0, 255, 255 }     // Magenta
#define RAYWHITE   CLITERAL(Color){ 245, 245, 245, 255 }   // My own White (raylib logo)
#define WHITE_TRANS   CLITERAL(Color){ 255, 255, 255, 150 }   // WHITE TRANS
#define WHITE_TRANS_1   CLITERAL(Color){ 255, 255, 255, 200 }   // WHITE TRANS
#define CELL_SELECT   CLITERAL(Color){ 255, 201, 114, 255 }  // Cell select color( orage yellow )
